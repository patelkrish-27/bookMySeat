...
export function SignupPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: '#07070f' }}>
      ...
      <div className="glass-orb glass-orb-blue" style={{ width: 400, height: 400, top: '5%', left: '-10%' }} />
      <div className="glass-orb glass-orb-crimson" style={{ width: 300, height: 300, bottom: '15%', right: '-5%', animationDelay: '-5s' }} />
