    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#07070f' }}>
      ...
      >
        ...
        {successMsg && (
          <div
            className="text-sm px-4 py-3 rounded-xl mb-5"
            style={{ background: 'rgba(50,200,100,0.1)', border: '1px solid rgba(50,200,100,0.3)', color: '#6ee7a0' }}
          >
            {successMsg}
          </div>
        )}
          ...
          <div className="flex gap-3 justify-center mb-7" onPaste={handlePaste}>
            {digits.map((d, i) => (
              <input
                ...
                className="w-12 h-14 text-center text-xl font-mono-dm font-bold rounded-xl outline-none transition-all"
                style={{
                  background: 'rgba(255,255,255,0.05)',
                  border: d ? '1px solid rgba(212,166,58,0.6)' : '1px solid rgba(255,255,255,0.1)',
                  color: '#f0f0f8',
                }}
                onFocus={e => {
                  e.currentTarget.style.border = '1px solid rgba(212,166,58,0.8)'
                  e.currentTarget.style.background = 'rgba(255,255,255,0.08)'
                }}
                onBlur={e => {
                  e.currentTarget.style.border = d ? '1px solid rgba(212,166,58,0.6)' : '1px solid rgba(255,255,255,0.1)'
